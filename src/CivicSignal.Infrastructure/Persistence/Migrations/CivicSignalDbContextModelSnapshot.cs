...
namespace CivicSignal.Infrastructure.Persistence.Migrations
{
    ...
    partial class CivicSignalDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CivicSignal.Domain.Incidents.Incident", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("DuplicateLinkedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("duplicate_linked_at");

                    b.Property<Guid?>("DuplicateLinkedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("duplicate_linked_by_user_id");

                    b.Property<string>("PublicTrackingCode")
                        .IsRequired()
                        .HasMaxLength(12)
            ...
            modelBuilder.Entity("CivicSignal.Infrastructure.Identity.ApplicationRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("CivicSignal.Infrastructure.Identity.ApplicationRefreshToken", b =>
                {
                    b.HasOne("CivicSignal.Infrastructure.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
